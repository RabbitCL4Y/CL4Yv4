...
echo $yellow" 41) brute-webdav"
echo $yellow" 42) AdminFinder"
echo $yellow" 43) termux-ubuntu"
echo $yellow" 45) kalinethunter"
echo $yellow" 46) weeman"
echo $yellow" 47) hakku"
echo $yellow" 48) hash-buster"
echo $yellow" 49) katoolin"
echo $yellow" 50) archlinux"
echo  $red" 0) Exit "
echo  $white""
read -p "[Mr.CL4Y]> " bro;
...
then
clear
echo $red"installing brute-webdav-RCT"
sleep 1
git clone https://github.com/RabbitCL4Y/brute-webdav
mv brute-webdav $HOME
echo  $red" T E R I N S T A L L "
exit
fi
if [ $bro = 42 ] || [ $bro = 42 ]
then
clear
echo $red" Installing AdminFinder "
sleep 1
pkg update && pkg upgrade
pkg install python2
pkg install git
...
then
clear
echo $red" Installing KaliLinuxNetHunter "
sleep 1
pkg update && pkg upgrade
pkg install git
git clone https://github.com/Cyb3r3x3r/kaliLinuxNethunter-termux.git
...
then
clear
echo $red" Installing Hash-Buster "
sleep 1
pkg update && pkg upgrade
pkg install python2
pkg install git
...
then
clear
echo $green" installing katoolin "
sleep 1
apt update && apt upgrade
pkg install git
pkg install python
